...
$(document).ready(function(){
             ...
             else
            {
                ...
                $.post('modify_service_sms',{id:uid,status:st,mobile:mobile},function(res)
				{
                //alert(res);         
                  if(res==1)
                     {
                      alert('Updated successfully'); 
					  setTimeout('window.location = "update_service_contact_number"');  
                     }
                     else{
                      alert('not Updated ');   
                     }
...
<p align="right" style="padding-right:220px; padding-top:10px;"><?php echo anchor('master_control/update_service_contact_number','Go Back'); ?></p>
...
?>    
  <table align="center" cellspacing="10" style="margin: 0px auto;" id="tbl">
        ...
        <td align="left"><input type="text" id="ag_mobile" nam="ag_mobile" value="<?php echo $rows->contact;?>" ></td>
        </tr>
