...
<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title">Welcome Admin</a></h1>
			<h2 class="section_title"></h2><div class="btn_view_site"><?php echo anchor('master_control/logout', 'Logout'); ?></div>
		</hgroup>
	</header> <!-- end of header bar -->
	
	<section id="secondary_bar">
		<div class="user">
			<p><?php echo $this->session->userdata('username'); ?> <!---(<a href="#">3 Messages</a>)---></p>
