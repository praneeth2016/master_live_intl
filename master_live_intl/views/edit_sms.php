...
$(document).ready(function(){
             ...
             else
            {
                ...
                $.post('modify_apisms',{id:uid,status:st,mobile:mobile},function(res)
				{
                //alert(res);         
                  if(res==1)
                     {
...
<p align="right" style="padding-right:220px; padding-top:10px;"><?php echo anchor('master_control/update_contact_number','Go Back'); ?></p>
<h4 align="center">Edit Details</h4>
<?php
foreach ($query as $rows) {
    $id=$rows->id;
    $is_api_sms = $rows->is_api_sms;
