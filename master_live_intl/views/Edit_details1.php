...
<script type="text/javascript" src="<?php echo base_url("js/jquery-1.9.2.min.js");?>"></script>
<script>
function validate()
{
   ...
   /* if(name=='')
	...
	{*/
	   	...
	   	if(r==true)
	   	{
       		$.post("update_agent_formdetails2",{
		   		uid:uid,name:name,username:username,password:pword,email_address:email,address:add,contact:con,landline:landline,margin:margin,limit:limit,ip:ip,api_key:api_key,branch:branch,branch_address:branchAddress,stat:stat,allowcanc:allowcanc,allowmodification:allowmodification,payment_reports:payment_reports,booking_reports:booking_reports,passenger_reports:pass_reports,vehicle_assignment:vehicle_ass,ticket_booking:ticket_booking,check_fare:checkfare,ticket_status:ticket_status,ticket_cancellation:ticket_canc,ticket_modify:ticket_modify,board_passenger_reports:boardpass,ticket_reschedule:ticket_reschedule,group_boarding_passenger_reports:groupboardpass
            },function(res)
			{
                ...
                if(res==1)
				{
					alert("Agent Updated Successfully!!!");
				 	window.location='<?php echo base_url("master_control/api_agents")?>';                  	
                }
             	else
				{
...
<table width="73%" border="0" cellspacing="0" cellpadding="0" align="center" >
  ...
  <tr>
    <td height="30" class="space">Edit API Agent</td>
  </tr>
  <tr>
    <td height="30" class="space" align="right"><span style="padding-right:20px;"><?php echo anchor('master_control/api_agents','Go Back'); ?></span></td>
  </tr>
  <tr>
    <td height="30">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">      
      <tr>
        ...
        <td height="30" colspan="3" align="center"><strong> <span class="space">API</span> Agent </strong></td>
        <td width="2%" height="30">&nbsp;</td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
        ...
        <td width="2%">&nbsp;</td>
        <td width="49%" height="30"><input type="text" id="name" name="name" value="<?php echo $name; ?>"  />
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td height="30"><input type='text' id='txt' name='txt' size='20' value="<?php echo trim($bal_limit); ?>" /></td>
        <td height="30">&nbsp;</td>
      </tr>
	  <tr>
        <td height="30">&nbsp;</td>
	  ...
	  <tr>
        <td height="30">&nbsp;</td>
        <td height="30" align="right">API KEY </td>
        <td>&nbsp;</td>
        <td height="30"><input type='text' id='ip' name='ip' size='20' value="<?php echo $ip; ?>" disabled="disabled" />
        <input type='text' id='apikey' name='apikey' size='20' value="<?php echo $api_key; ?>" disabled="disabled" /></td>
        <td height="30">&nbsp;</td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td height="30"><input type='text' id='bran' name='bran' size='20' value="<?php echo $branch; ?>"  /></td>
        <td height="30">&nbsp;</td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
      ...
      <tr>
		...
		<input type="button" id="add_new" name="add_new" value="Update" onclick="validate();"/></td>
        <td height="40">&nbsp;</td>
      </tr>
      <tr>
        <td height="40">&nbsp;</td>
