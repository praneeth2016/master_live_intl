...
<script>
    ...
    {	var id = $('#id').val();
        ...
        {
            var r = confirm('Are You Sure You Want To Update Promo code');
            if (r == true)
            {
                $.post('promocodes_update2', {id:id,promocode: promocode, promovalue: promovalue, from_date: from_date, to_date: to_date, promovalue_type: promovalue_type}, function (res)
                {
                    //alert(res);
                    if (res == 1)
                    {
...
<table  border="0" cellpadding="0" cellspacing="0" align="center" width="60%">
    <tr>
        <td height="30" class="space" style="border-bottom:#f2f2f2 solid 1px;">Update Promo Codes </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td><input type="text" name="promocode" id="promocode" value="<?php echo $promocode;?>" />
                ...
                <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td><input type="text" name="promovalue" id="promovalue"  value="<?php echo $value;?>" /></td>                    
                </tr>
                <tr>
