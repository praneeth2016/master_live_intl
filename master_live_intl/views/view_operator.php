<html> 
          ...
          if(con===true)
              {
               $.post("active_in",{status:s,id:uid},function(res){
                 ...
                 if(res===1){
                     ...
                     setTimeout('window.location = "view_all"',2000);
                 }
                 else
                     {
                     alert('status has been changed');
    ...
    <h1 align='center' style='font-size:16px'> Operators</h1>
</html>
<?php
echo "<table align='center' cellspacing='10px' cellpadding='10px' style='margin: 0px auto;'>";
echo "<tr>";
